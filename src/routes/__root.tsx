...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Olivera — Modern Bistro Menu & Ordering" },
      { name: "description", content: "Browse Olivera's seasonal menu, explore each dish, and place your order in a few taps." },
      { property: "og:title", content: "Olivera — Modern Bistro Menu & Ordering" },
      { property: "og:description", content: "Browse Olivera's seasonal menu, explore each dish, and place your order in a few taps." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Olivera — Modern Bistro Menu & Ordering" },
      { name: "twitter:description", content: "Browse Olivera's seasonal menu, explore each dish, and place your order in a few taps." },
