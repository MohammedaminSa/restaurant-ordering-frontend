...
const navItems: NavItem[] = [
  ...
  { label: "Checkout / Payments", icon: DollarSign, to: "/dashboard/cashier/checkout", roles: ["cashier"] },
  { label: "Transactions", icon: History, to: "/dashboard/cashier/transactions", roles: ["cashier"] },
  { label: "Tables", icon: TableIcon, to: "/dashboard/cashier/tables", roles: ["cashier"] },
  { label: "Reports", icon: TrendingUp, to: "/dashboard/cashier/reports", roles: ["cashier"] },
  { label: "Settings", icon: Settings, to: "/dashboard/cashier/settings", roles: ["cashier"] },
  { label: "Overview", icon: LayoutDashboard, to: "/dashboard/waiter", roles: ["waiter"] },
